...
<head>
  ...
  <script src="../js/historial/historial.js"></script>
      ...
      <div class="col-lg-12 no-margin no-padding">
        ...
        <div class="row">
          ...
          <div class="container-icon text-center">
            <img onclick="location.href= 'vista6.html'" src="../img/configurationgearoutline_80750.png" class="icons">
          </div>
          <div class="container-icon text-center">
      ...
      <div class="col-lg-8 container-form margin-form">
        <div class="row row-form">
          ...
          <input type="hidden" id="id_area" value="<?php echo $obtener->getUsu_area(); ?>">
            <table class="table table-bordered" width="100%" id="historial">
              <thead>
                <tr>
                  <th>Producto</th>
                  <th>Cantidad</th>
